<script type="text/template" id="yrc-main-tmpl">
	...
	<div id="pbc-feedback">
		<a class="button" href="mailto:suggest@plugin.builders?subject=Extend YourChannel" target="_blank"><?php _e('Suggest Feature', 'YourChannel'); ?></a>
		<a class="button" href="mailto:support@plugin.builders?subject=YourChannel Problem" target="_blank"><?php _e('Report Issue', 'YourChannel'); ?></a>
		...
		<a class="button" href="http://plugin.builders/yourchannel/support" target="_blank"><?php _e('Docs & Troubleshooting', 'YourChannel'); ?></a>
	</div>
</script>				
...
<script type="text/template" id="yrc-lang-form-tmpl">
	...
	<div class="pbc-front-form">
		<h2 class="wpb-pointer pbc-front-form-header"><?php _e('Videos from mutiple sources', 'YourChannel'); ?></h2>
		<div class="pbc-front-form-inputs">
			<p>Make video galleries with videos from YouTube, Vimeo, Facebook, Uploads, Links with our new video gallery plugin.</p>
			<a class="button" target="_blank" href="http://plugin.builders/frames/demo/?from=yourchannel">Demo</a>
			<a class="button" target="_blank" href="<?php echo admin_url(); ?>plugin-install.php?tab=plugin-information&plugin=frames-video-gallery&TB_iframe=true&width=772&height=840">Plugin Details</a>
		</div>
	</div>
